...
public class ProdutoDetalheActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("vendas/produtos/" + produto.getKey() + "/quantidade");
        // Escuta o database
                ...
                if(AppSetup.cliente == null){
                    ...
                    if(etQuantidade.getText().toString().isEmpty()){
                        ...
                        if(quantidade <= produto.getQuantidade()){
                            ...
                            CarrinhoActivity.pedido.setTotalPedido(CarrinhoActivity.pedido.getTotalPedido() + item.getTotalItem());
